...
$posts_list = popular_post_list($connection, $get_active_sorting_type, $get_sorting_order, 6);
/* Список популярных  постов  */
if (isset($_GET['content_type_id'])) {
    if($_GET['content_type_id'] === 'all') {
        $posts_list = popular_post_list($connection, $get_active_sorting_type, $get_sorting_order);
    }
    else{

            ...
            <div class="adding-post__tabs filters">
              <ul class="adding-post__tabs-list filters__list tabs__list">
                ...
                <li class="adding-post__tabs-item filters__item">
                  <a class="adding-post__tabs-link filters__button filters__button--<?=$content_type['icon_name']; ?> photo filters__button--active <?php if ($form_type == $content_type['icon_name']):?> tabs__item--active filters__button--active<?php endif; ?>" href="#">
